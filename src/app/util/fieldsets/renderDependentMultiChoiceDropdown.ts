...
import O80MultiselectDropdown from 'app/component/organism/o80-multiselect-dropdown/O80MultiselectDropdown.lazy';

export const renderDependentMultiChoiceDropdown = (

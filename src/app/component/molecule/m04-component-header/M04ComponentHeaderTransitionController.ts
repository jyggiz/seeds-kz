...
class M04ComponentHeaderTransitionController extends AbstractTransitionController<M04ComponentHeader> {
  protected setupTransitionInTimeline(
    ...
    const image = parent.asset?.getImage();

    if (image) {
      timeline.add(TweenMax.fromTo(image, 0.5, { autoAlpha: 0 }, { autoAlpha: 1 }));
    }

...
import ProgressBar from '../../molecule/progress-bar/ProgressBar.lazy';
...
export default class VideoControls extends AbstractComponent {
  ...
  public adopted() {
    ...
    this.addDisposableEventListener(this.video.dispatcher, VideoEvent.ENDED, this.onEnd.bind(this));

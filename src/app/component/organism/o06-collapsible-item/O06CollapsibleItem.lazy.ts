...
import { O06CollapsibleItemEvent } from './o06-collapsible-item.utils';
import { getComponentForElement } from 'muban-core';

import './o06-collapsible-item.scss';
...
export default class O06CollapsibleItem extends AbstractComponent {
  ...
  private readonly toggleButtonComponent =
    this.toggleButton && getComponentForElement<M14ToggleButton>(this.toggleButton);
  ...
  private handleToggleButtonClick(): void {
    if (this.collapsible) {
      ...
      this.dispatcher.dispatchEvent(
        new O06CollapsibleItemEvent(O06CollapsibleItemEvent.types.CLICK, {
